...
public class Owner_Page {
	...
	public static Selector productAvailablePara = new Selector(SelectorType.XPATH, "//p[@class='app-font']");

	public static String ownerUSCitizen = "//div[@id='question_40745']";
	public static Selector valOwnerUSCitizen = new Selector(SelectorType.XPATH,
			"//label//span[normalize-space(text())='Is the Owner a US Citizen or Resident Alien?']//parent::label//parent::div//following-sibling::div/label");
	...
	public static Selector stateCountryOfIssuance = new Selector(SelectorType.XPATH,
			"//label//span[contains(normalize-space(text()),'State / Country of Issuance')]//parent::label//parent::div//following-sibling::div/input");
	...
	public static Selector currentResidence = new Selector(SelectorType.XPATH,
			"//label//span[normalize-space(text())='Current Residence']//parent::label//parent::div//following-sibling::div");
	...
	public static Selector guardianPrefix = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[normalize-space(text())='Prefix']//parent::label//parent::div//following-sibling::div");
	public static Selector guardianFirstName = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[normalize-space(text())='First Name']//parent::label//parent::div//following-sibling::div/input");
	public static Selector guardianInitial = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[contains(normalize-space(text()), 'Middle Name') or contains(normalize-space(text()), 'Initial')]//parent::label//parent::div//following-sibling::div/input");
	public static Selector guardianlastName = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[normalize-space(text())='Last Name']//parent::label//parent::div//following-sibling::div/input");
	public static Selector guardianSuffix = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[normalize-space(text())='Suffix']//parent::label//parent::div//following-sibling::div");
	public static Selector guardianPhoneNumber = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[normalize-space(text())='Phone Number']//parent::label//parent::div//following-sibling::div/input");
	public static Selector guardianEmailAddress = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[normalize-space(text())='Email Address']//parent::label//parent::div//following-sibling::div/input");
	public static Selector guardianEmailAddressConfirmation = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[normalize-space(text())='Email Address Confirmation']//parent::label//parent::div//following-sibling::div/input");

	public static Selector guardianFormOfIdentification = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[contains(normalize-space(text()),'Form of Identification')]//parent::label//parent::div//following-sibling::div");
	public static Selector guardianFormOfIdentificationother = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div(//label[span[contains(normalize-space(text()), 'Form of Identification')]] //ancestor::div[3] //following-sibling::div//label[span[contains(normalize-space(text()), 'Other (please specify)')]] //parent::div//following-sibling::div/input)");
	public static Selector guardianNumberOnIdentification = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[contains(normalize-space(text()),'Number on Identification')]//parent::label//parent::div//following-sibling::div/input");
	public static Selector guardianStateCountryOfIssuance = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[contains(normalize-space(text()),'State / Country of Issuance')]//parent::label//parent::div//following-sibling::div/input");
	public static Selector guardianIdentificationExpirationDate = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()), 'Guardian')]//parent::div//label//span[contains(normalize-space(text()),'Identification Expiration Date')]//parent::label//parent::div//following-sibling::div//input");
