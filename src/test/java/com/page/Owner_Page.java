...
public class Owner_Page {
	...
	public static Selector stateCountryOfIssuance = new Selector(SelectorType.XPATH,
			"//label//span[contains(normalize-space(text()),'State or Country of Issuance')]//parent::label//parent::div//following-sibling::div/input");
	...
	public static Selector guardianEmailAddressConfirmation = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()),'Guardian')]/parent::div//following-sibling::div//label//span[normalize-space(text())='Email Address Confirmation']//parent::label//parent::div//following-sibling::div/input");

	public static Selector guardianFormOfIdentification = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()),'Guardian')]/parent::div//following-sibling::div//label//span[contains(normalize-space(text()),'Form of Identification')]//parent::label//parent::div//following-sibling::div");
	public static Selector guardianFormOfIdentificationother = new Selector(SelectorType.XPATH,
			"//h3[contains(normalize-space(text()),'Guardian')]/parent::div//following-sibling::div(//label[span[contains(normalize-space(text()), 'Form of Identification')]] //ancestor::div[3] //following-sibling::div//label[span[contains(normalize-space(text()), 'Other (please specify)')]] //parent::div//following-sibling::div/input)");
